...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    //CGSize cgsize = CGSizeMake(3860, 3860);
     ...
     NSImage *img = [[NSImage alloc] initWithSize: NSMakeSize(3860, 3860)];
     ...
     CGImageSource imgSource = CGImageSourceCreateWithData(imgData, nil);
     var cgimg: CGImage = CGImageSourceCreateImageAtIndex(imgSource, 0, nil)
     ...
     //
     //        CGImageDestinationAddImage(d, cgimg, nil)blackColor()
     black.setFill()
     NSRectFill(NSMakeRect(0, 0, 3860, 3860))
     img.unlockFocus()
